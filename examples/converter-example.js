...
// Simple usage
console.log(convert({ from: "10 hr 20 mn 30 sec", to: "minutes", type: "time", withUnits: true })); // 3600
console.log(convert({ from: "1 mn", to: "seconds", type: "time", withUnits: true })); // 60
console.log(convert({ from: "1 second", to: "seconds", type: "time", withUnits: true })); // 1
console.log(convert({ from: "8:30pm @Asia/Kolkata", to: "hr", type: "time", withUnits: true })); // Timezone does not matter.

//test pass **dont change this format for now**
console.log(convert({ from: ["17/03/2024, 6:30 AM @Asia/Calcutta", "17/04/2024, 22:30"], to: "hours", type: "time", withUnits: true })); // Date with timezone
...
console.log(convert({ from: ["now", '6:30 PM'], to: "hr", type: "time", withUnits: true })); // Date with timezone
// // Examples with "now":
